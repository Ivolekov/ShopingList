...
namespace ShopingList.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(ShopingListDBContext context)
        {
            _context = context;
        }
        ...
        {
            var shopingListDBContext = _context.Products.Include(p => p.Category);
            return View(await shopingListDBContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ShopingListDBContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
